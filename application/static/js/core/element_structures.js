...
const AUTOMATION_MODAL_CONFIGURATION = {
    id: "automationModal",
    title: TEXT_ADD_AUTOMATION,
    submitFunction: () => addAutomation(),
    isMultiStep: true,
    ...
    steps: [
            ...
            columns: [
                {
                    ...
                    blocks: [
                        ...
                        {
                            blockType: MODAL_BLOCK_TYPE_TILE_SELECT,
                            id: "automationTriggerTileSelect",
                            isRadioButton: true,
                            title: TEXT_TRIGGER,
                            validations: [
                                {
                            ...
                            tiles: AUTOMATION_TRIGGER_TILE_SELECT_OPTIONS
                        },
                    ]
                }
            ]
        },
        {
            ...
            columns: [
                {
                    isFieldset: true,
                    title: TEXT_TIME_WINDOW,
                    blocks: [
                        {
                            blockType: MODAL_BLOCK_TYPE_INPUT,
                            id: "automationActivateTimeWindowCb",
                            title: TEXT_ACTIVATE_TIME_WINDOW,
                            onclickFunction: () => loadTriggerTimeWindowFields(),
                            type: "toggle"
                        },
                        {
                            blockType: MODAL_BLOCK_TYPE_INPUT,
                            id: "automationActivateDuringTimeWindowCb",
                            blockId: "automationActivateDuringTimeWindowCbContainer",
                            title: TEXT_ACTIVATED_DURING_TIME_WINDOW,
                            type: "toggle"
                        },
                        {
                            blockType: MODAL_BLOCK_TYPE_INPUT,
                            id: "automationTriggerActivationTimeTime",
                            blockId: "automationTriggerActivationTimeTimeContainer",
                            title: TEXT_ACTIVATION_TIME,
                            type: "time",
                            validations: [
                                {
                                    type: VALIDATION_NOT_NULL
                        ...
                        {
                            blockType: MODAL_BLOCK_TYPE_INPUT,
                            id: "automationTriggerDectivationTimeTime",
                            blockId: "automationTriggerDectivationTimeTimeContainer",
                            title: TEXT_DEACTIVATION_TIME,
                            type: "time",
                            validations: [
                                {
                                    type: VALIDATION_NOT_NULL
        ...
        {
            id: "configureTimeStep",
            title: "Configure time step",
            columns: [
                {
                    isFieldset: false,
                    blocks: [
                        {
                            blockType: MODAL_BLOCK_TYPE_INPUT,
                            id: "automationActivationTimeTime",
                            title: TEXT_ACTIVATION_TIME,
                            type: "time",
                            validations: [
                                {
                        ...
                        },
                        {
                            ...
                            tiles: DAYS_TILE_SELECT_OPTIONS
                        },
                    ]
                }
            ]
        ...
        {
            id: "configureSensorStep",
            title: "Configure sensor step",
            columns: [
                {
                    isFieldset: false,
                    blocks: [
                        {
                            blockType: MODAL_BLOCK_TYPE_TILE_SELECT,
                            id: "automationTriggerDevicesTileSelect",
                            title: TEXT_TRIGGER_DEVICES,
                            validations: [
                                {
                                    type: VALIDATION_NOT_NULL
                                }
                        ...
                        {
                            blockType: MODAL_BLOCK_TYPE_INPUT,
                            id: "automationTriggerStateSelect",
                            title: TEXT_TRIGGER_STATE,
                            type: "select",
                            validations: [
                                {
                                    type: VALIDATION_NOT_NULL,
                        ...
                        {
                            blockType: MODAL_BLOCK_TYPE_INPUT,
                            id: "automationDelayRange",
                            title: TEXT_AUTOMATION_DELAY,
                            type: "range",
                            oninputFunction: () => updateDelayTimeField()
                        },
                    ]
                },
            ]
        ...
        {
            id: "configureTargetStep",
            title: "Configure action step",
            columns: [
                {
                    isFieldset: false,
                    blocks: [
                        {
                            blockType: MODAL_BLOCK_TYPE_TILE_SELECT,
                            id: "automationTargetDevicesTileSelect",
                            title: TEXT_TARGET_DEVICES,
                            validations: [
                                {
                                    type: VALIDATION_NOT_NULL
                        ...
                        {
                            blockType: MODAL_BLOCK_TYPE_INPUT,
                            id: "automationActionSelect",
                            blockId: "automationActionSelectContainer",
                            title: TEXT_ACTION,
                            type: "select",
                            onchangeFunction: () => loadActionParameters(),
                            validations: [
                                {
                                    type: VALIDATION_NOT_NULL,
                                    nullValue: -1
                        ...
                        {
                            blockType: MODAL_BLOCK_TYPE_INPUT,
                            id: "devicePowerSelect",
                            blockId: "devicePowerSelectContainer",
                            title: TEXT_POWER,
                            type: "select",
                            onchangeFunction: () => loadInvertedAutomationCopyFields(),
                            validations: [
                                {
                                    type: VALIDATION_NOT_NULL,
                                    nullValue: -1
                            ...
                            options: DEVICE_POWER_SELECT_OPTIONS
                        },
                        {
                            blockType: MODAL_BLOCK_TYPE_INPUT,
                            id: "ledstripColorColor",
                            blockId: "ledstripColorColorContainer",
                            title: TEXT_COLOR,
                            type: "color",
                            validations: [
                                {
                        ...
                        {
                            blockType: MODAL_BLOCK_TYPE_INPUT,
                            id: "ledstripModeSelect",
                            blockId: "ledstripModeSelectContainer",
                            title: TEXT_MODE,
                            type: "select",
                            validations: [
                                {
        ...
        {
            id: "configureInvertedStep",
            title: "Configure inverted automation copy",
            columns: [
                {
                    isFieldset: false,
                    blocks: [
                        {
                            blockType: MODAL_BLOCK_TYPE_INPUT,
                            id: "automationInvertedEnabledCb",
                            title: TEXT_ADD_INVERTED_COPY,
                            onclickFunction: () => loadInvertedAutomationCopyFields(),
                            type: "toggle"
                        },
                        {
                            blockType: MODAL_BLOCK_TYPE_INPUT,
                            id: "delayThisAutomationCb",
                            blockId: "delayThisAutomationCbContainer",
                            title: TEXT_DELAY_THIS_AUTOMATION,
                            type: "toggle"
                        },
                        {
                            blockType: MODAL_BLOCK_TYPE_INPUT,
                            id: "delayInvertedAutomationCb",
                            blockId: "delayInvertedAutomationCbContainer",
                            title: TEXT_DELAY_INVERTED_AUTOMATION,
                            type: "toggle"
                        },
                        {
                            blockType: MODAL_BLOCK_TYPE_INPUT,
                            id: "timeInvertedActionTime",
                            blockId: "timeInvertedActionTimeContainer",
                            title: TEXT_TIME_TURNING_OFF,
                            type: "time",
                            validations: [
                                {
                                    type: VALIDATION_NOT_NULL
