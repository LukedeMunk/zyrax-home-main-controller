 ...
 */
/******************************************************************************/
/* Global texts words (alpabetical order) */
...
const TEXT_TIME_WINDOW = "Time window";
...
const TEXT_SENSOR_MODEL = "Sensor model";
const TEXT_CONTACT_SENSOR = "Contact sensor";
...
const TEXT_MOTION_SENSOR = "Motion sensor";
const TEXT_SWITCH = "Switch";
...
const TEXT_DEACTIVATION_TIME = "Deactivation time";
...
const TEXT_NO_DEVICES = "No devices";
const TEXT_FIRST_SELECT_TYPE = "First select a type";
...
const TEXT_INVALID_FILENAME = "Invalid filename, filename must be something like 'vX.X.X.bin'";
...
const TEXT_AUTOMATION = "Automation";
const TEXT_CHANGE_TILE_SIZE = "Change tile size";
const TEXT_NETWORK_ERROR = "Network error";
...
const TEXT_PROFILES = "Profiles";
const TEXT_DONT_REMEMBER_ME = "I will rememberUser you the next time. Click to disable that";
const TEXT_REMEMBER_ME = "I won't know who you are the next time. Click so that I rememberUser you";
...
const TEXT_THIS_FIELD_NEEDS_TO_BE_UNIQUE = "This field must be unique";
const TEXT_THIS_FIELD_IS_REQUIRED = "This field is required";
const TEXT_TOO_MANY_CHARACTERS = "This field contains too many characters";
const TEXT_CURRENT_PASSWORD = "Current password";
const TEXT_NEW_PASSWORD = "New password";
const TEXT_RETYPE_PASSWORD = "Repeat password";
const TEXT_LENGTH_BETWEEN_8_AND_64 = "Between 8 and 64 characters";
const TEXT_AT_LEAST_ONE_UPPER_CASE_CHARACTER = "At least one uppercase character";
const TEXT_AT_LEAST_ONE_LOWER_CASE_CHARACTER = "At least one lowercase character";
const TEXT_AT_LEAST_8_CHARACTERS = "At least 8 characters";
const TEXT_AT_LEAST_ONE_NUMBER = "At least one digit";
const TEXT_AT_LEAST_ONE_SYMBOL = "At least one symbol (!, @, #, etc.)";
const TEXT_INVALID_PASSWORD = "Invalid password";
const TEXT_PASSWORD_UPDATED_SUCCESSFULLY = "Password updated successfully";
const TEXT_PASSWORDS_NOT_IDENTICAL = "The provided passwords do not match";
const TEXT_PASSWORD_DOES_NOT_FULFILL_REQUIREMENTS = "The password does not meet the requirements";
const TEXT_CANNOT_MOVE_WHEN_TABLE_IS_FILTERED = "Reordering is only possible when the table is not filtered";
const TEXT_CLICK_TO_SORT = "Click to sort";
const TEXT_CLICK_TO_SORT_DESCENDING = "Click to sort descending";
const TEXT_CLICK_FOR_DEFAULT_SORTING = "Click for default sorting";
const TEXT_SELECT_FILTERS = "Select filters";
const TEXT_CONFIGURATION = "Configuration";

/* Variable texts */
function VAR_TEXT_CHOOSE_A_HIGHER_VALUE(minimumValue) {return "Choose a value higher than " + minimumValue + "";}
function VAR_TEXT_CHOOSE_A_LOWER_VALUE(maximumValue) {return "Choose a value lower than " + maximumValue + "";}
function VAR_TEXT_TEXT_PASSWORD_UPDATED_WARNING(warning) {return "Password successfully updated, but " + warning;}
/* New or updated texts (to be implemented in other languages and alphabetized) */




const TEXT_AUTOMATIONS = "Automations";

const TEXT_MANAGE_PROFILE = "Manage profile";
const TEXT_MANAGE_PROFILES = "Manage profiles";
const TEXT_MANAGE_ACCOUNT = "Manage account";
const TEXT_ACCOUNT_INFORMATION = "Account information";

const TEXT_HELP = "Help";
const TEXT_UI_THEME = "UI theme";

const TEXT_DASHBOARDS_OVERVIEW = "Dashboards overview";
const TEXT_AUTOMATION_COMPLETED = "Completed";
const TEXT_AUTOMATION_RUNNING = "Running...";
const TEXT_AUTOMATION_RUN_FAILED = "Run failed";
const TEXT_CHOOSE_TILE_TYPE = "Choose a tile type, target and size.";
const TEXT_CLOSE_CONFIGURATION = "Close configuration";
const TEXT_CONFIGURE_DASHBOARD = "Configure dashboard";
const TEXT_CREATE_DASHBOARD = "Create dashboard";
const TEXT_DASHBOARD_CONFIGURATION_DESCRIPTION =
    "Drag tiles to a free position or use their options button.";
const TEXT_MANAGE_DASHBOARD = "Manage dashboard";
const TEXT_NO_DASHBOARDS =
    "Create a dashboard to start adding devices and automations.";
const TEXT_Q_DELETE_TILE = "Do you want to delete this tile?";
const TEXT_READY_TO_RUN = "Tap to run";
const TEXT_RENAME_DASHBOARD = "Rename dashboard";
const TEXT_TILE_OPTIONS = "Tile options";
const TEXT_EDIT_GROUP_ICON = "Edit group icon";
const TEXT_WEATHER_LOCATION = "Weather location";
const TEXT_LOCATION = "Location";
const TEXT_IP_ADDRESS = "IP address";
const TEXT_MY_DEVICE_IS_NOT_SHOWN_HERE = "My device is not shown here";
const TEXT_GO_TO_NEXT_STEP = "Go to next step";
const TEXT_ACTIVATED_DURING_TIME_WINDOW = "Activated during time window";
const TEXT_RF_DEVICE = "RF device";
const TEXT_IP_CAMERA = "IP camera";
const TEXT_DEVICE = "Device";
const TEXT_GROUP = "Group";
const TEXT_DATETIME = "Date and time";
const TEXT_WEATHER = "Weather";
const TEXT_ALARM_NOT_TRIGGERED_YET = "Alarm is not triggered yet";
...
const TEXT_CONFIGURE_MODE = "Configure mode";
